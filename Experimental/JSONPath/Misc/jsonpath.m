...
static void yy_reduce(
  ...
  */
      case 0: /* program ::= expr */
#line 12 "jsonpath.lemon"
{ NSLog(@"result: %s", yymsp[0].minor.yy0); }
#line 643 "jsonpath.c"
        break;
      case 1: /* expr ::= expr MINUS expr */
      case 2: /* expr ::= expr PLUS expr */ yytestcase(yyruleno==2);
      case 3: /* expr ::= expr TIMES expr */ yytestcase(yyruleno==3);
#line 14 "jsonpath.lemon"
{  }
#line 650 "jsonpath.c"
        break;
      case 4: /* expr ::= expr DIVIDE expr */
#line 20 "jsonpath.lemon"
{
	}
#line 656 "jsonpath.c"
        break;
      case 5: /* expr ::= INTEGER */
#line 24 "jsonpath.lemon"
